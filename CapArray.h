...
// #define TACTILE_READER_V1
#define TACTILE_READER_V2

#ifdef TACTILE_READER_V1
    ...
    #define CAP_MEM_SIZE CAP_ROW_ARRAY_LEN*CAP_COLUMN_ARRAY_LEN
    ...
    #define CAP_ROW_SHLD1 0
    // #define CAP_ROW_SHLD2 
    #define CAP_ROW_CIN1 5
    #define CAP_ROW_CIN2 4
    #define CAP_ROW_CIN3 3
    #define CAP_ROW_CIN4 2
    #define CAP_ROW_GND 7
    #define CAP_ROW_Y_CONNECTIONS {"SHLD1", "CIN4", "CIN3", "CIN2", "CIN1", "GND"}


    #define CAP_COL_SHLD1 1
    // #define CAP_COL_SHLD2 
    #define CAP_COL_GND 2
    #define CAP_COLUMN_Y_CONNECTIONS {"SHLD1", "GND"}
#endif
